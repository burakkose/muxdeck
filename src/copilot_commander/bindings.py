...
DASHBOARD_BINDINGS: Final[list[BindingSpec]] = [
    ...
    Binding("K", "kill_agent", "Kill pane", show=False),
    Binding("p", "open_pane", "Focus console", show=False),
    Binding("R", "rename_window", "Rename window", show=False),
    Binding("W", "move_to_window", "Move to window", show=False),
...
WORKTREE_BINDINGS: Final[list[BindingSpec]] = [
    ...
    Binding("enter", "launch_agent", "Launch agent", show=False),
    Binding("s", "launch_agent", "Launch agent", show=False),
...
REPLAY_BINDINGS: Final[list[BindingSpec]] = [
    ...
    Binding("e", "chip_errors_only", "Errors only", show=False),
    Binding("a", "chip_activity", "Activity only", show=False),
    Binding("t", "chip_tool_calls", "Tool calls", show=False),
    Binding("c", "chip_clear", "Clear chips", show=False),
    Binding("i", "toggle_insights", "Insights panel", show=False),
...
REPLAY_HINTS = (
    ...
    KeyHint("f", "follow"),
    KeyHint("[/]", "markers"),
    KeyHint("A", "activity jump"),
    KeyHint("x", "problem"),
    KeyHint("F", "file edit"),
    KeyHint("b", "bookmark"),
    KeyHint("n", "note"),
    KeyHint("N", "next note"),
    KeyHint("E", "export/save"),
    KeyHint("g", "latest"),
    KeyHint("e", "errors only"),
    KeyHint("a", "activity"),
    KeyHint("t", "tool calls"),
    KeyHint("c", "clear chips"),
    KeyHint("i", "insights"),
...
SESSIONS_BINDINGS: Final[list[BindingSpec]] = [
    ...
    Binding("enter", "open_replay", "Replay", show=False),
    Binding("slash", "focus_filter", "Filter", show=False),
    Binding("escape", "escape_filter", "Back to list", show=False, priority=True),
