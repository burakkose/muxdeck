...
from copilot_commander.widgets.dashboard import AlertPanel, FleetHealthPanel
...
class OperationsScreen(ShellScreen):
    ...
    def __init__(self, runtime: CommanderRuntime, controller: OperationsScreenController) -> None:
