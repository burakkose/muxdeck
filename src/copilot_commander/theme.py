...
reference a single source of truth.  Palette based on the Gruvbox
community spec (dark, medium contrast).
"""
...
TONE_HEALTHY_BG: Final[str] = "#2b3328"
TONE_HEALTHY_FG: Final[str] = GREEN
TONE_WARNING_BG: Final[str] = "#3c3020"
TONE_WARNING_FG: Final[str] = YELLOW
TONE_CRITICAL_BG: Final[str] = "#3c2020"
...
BADGE_BG: Final[str] = BLUE
BADGE_FG: Final[str] = BG_HARD
SELECTED_ROW_BG: Final[str] = BG2
ATTENTION_ROW_BG: Final[str] = "#3c3020"
